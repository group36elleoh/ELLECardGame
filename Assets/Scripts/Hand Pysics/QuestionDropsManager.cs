...
public class QuestionDropsManager : MonoBehaviour
{
    ...
    {
        // Creates the QDA
        newQuestionDropArea = Instantiate(questionDropNode, new Vector2(0, 15.5f - (questionDropGOs.Length*3.0f)), Quaternion.identity); // -14, 16
        ...
        Debug.Log("ADDING THIS TO CURRENT QUESTIONS: " + question.getQuestionPhrase());
